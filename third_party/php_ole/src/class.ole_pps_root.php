...
class ole_pps_root extends ole_pps {
    ...
    {
        call_user_func_array(array($this, 'ole_pps_root'), $args);
    }
...
#0.Initial Setting for saving
  ...
  $bigBlockSize = isset($rhInfo->_BIG_BLOCK_SIZE) ? $rhInfo->_BIG_BLOCK_SIZE : false;
  $smallBlockSize = isset($rhInfo->_SMALL_BLOCK_SIZE) ? $rhInfo->_SMALL_BLOCK_SIZE : false;
  $rhInfo->_BIG_BLOCK_SIZE=pow(2, (($bigBlockSize) ?
                                  _adjust2($bigBlockSize) : 9));
  $rhInfo->_SMALL_BLOCK_SIZE=pow(2, (($smallBlockSize) ?
                                    _adjust2($smallBlockSize) : 6));
