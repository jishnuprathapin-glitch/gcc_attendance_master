...
SELECT 'Timekeepers Attendance View', '/gcc_attendance_master/admin/timekeeper_attendance.php', 25, 1
WHERE NOT EXISTS (
  SELECT 1
  FROM gcc_it.sidebar_menu
  WHERE page = '/gcc_attendance_master/admin/timekeeper_attendance.php'
);
...
JOIN gcc_it.sidebar_menu m
  ON m.page = '/gcc_attendance_master/admin/timekeeper_attendance.php'
